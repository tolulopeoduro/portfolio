    ...
    return (
        <div id='contact' className={styles.contact}>
            ...
            <div className={styles.links}>
                <a href='https://api.whatsapp.com/send?phone=2347036845422' target="_blank">
                    <FontAwesomeIcon icon={faWhatsappSquare} className={styles.icon}/>
                </a>
                <a href='mailto:tolulopeoduro345@gmail.com' target="_blank">
                    <FontAwesomeIcon icon={faEnvelopeSquare} className={styles.icon}/>
                </a>
                <a href='https://github.com/tolulopeoduro' target="_blank">
                    <FontAwesomeIcon icon={faGithubSquare} className={styles.icon} />
                </a>
                <a href='https://www.linkedin.com/in/tolulope-oduro-58b7a41bb/' target="_blank">
